    ...
    public function up()
    {
        Schema::create('templates', function (Blueprint $table) {
            ...
            $table->unsignedInteger('parent_id')->default(0)->index();
              ...
              * Параметры шаблона.
              *
              * Используются при начальных параметрах (значениях) в шаблоне.
              * Например, могут задать доступ к странице, комментарии,
              * заполняемые поля, дополнительные поля, значения полей по умолчанию
              * и т.д., т.е. все данные участвующие в формировании страницы.
              *
              * Данное поле не используется в качестве критерия для выборки
              * страниц.
              */
             $table->text('options')->nullable(); // json

             /**
              * Описание параметров XML для формирования Sitemap.
              * Указанные параметры влияют только для страниц с указанным шаблоном.
              *
              * Данное поле не используется в качестве критерия для выборки
              * страниц.
              */
             $table->text('sitemap')->default(null)->nullable(); // json
